...
// CiExecutionConfig contains the default container image tags used for CI pipeline steps
type CiExecutionConfig struct {
...
// CiExecutionConfigResponse is the API response wrapper for the CI execution config endpoint
type CiExecutionConfigResponse struct {
	Status        string             `json:"status,omitempty"`
	Data          *CiExecutionConfig `json:"data,omitempty"`
